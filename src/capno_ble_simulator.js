...
// ------------------ CAPNO SIMULATOR ---------------//
// --------------------------------------------------//
var deviceName = "Capno-300"; // device name will always be Capno-XXXX where XXXX is serial id in hex
      ...
      if (isSendCalibration) {
        ...
        for (var i = 0; i < parseInt(readLength / 2); i++) {
          ...
          if (i % 3 == 0) {
            ...
            var sampleCo2 =
              Math.sin(2 * Math.PI * sineCo2Frequency * time) *
                sineCo2Amplitude +
              sineCo2Amplitude;
            totalSamples += 1;
